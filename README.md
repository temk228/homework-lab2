...
#Алгооритм и блок схема
1)Начало
2)Ввод переменных L и X
3)Процесс решения по формуле
4)Вывод результата
5)Конец
#Диаграма
...
исходные данные:
время X: 200.0 мс
длина шага L: 80.0 см
#Информация о разработчике
Медведкин Артем бТИИ-262
минимальная скорость передвижения: 4.00 м/с
